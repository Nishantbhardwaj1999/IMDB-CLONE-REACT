...
function Fav() {
  ...
  const [curGenre , setCurGenre]=useState('AllGenres')
...
//local fav movies
  ...
  filteredMovies = curGenre == "AllGenres" ? fav : fav.filter((movie) => genreids[movie.genre_ids[0]] == curGenre)
  // sorting 
  if (rating == 1) {
  ...
  <>
    ...
    <div className='mt-4'>
    <Pagination page={curPage} goAhead={goAhead} goBehind={goBehind} />
    </div>
  </>
  )
}
